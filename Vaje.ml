...
(* Funkcija "poisci k l" poišèe k-ti element v seznamu l.
 Številèenje elementov seznama (kot ponavadi) priènemo z 0.
...
(* Funkcija "rezina i k l" sestavi novi seznam, ki vsebuje elemente seznama l od vkljuèno
...
(* Funkcija "vstavi x k l" na k-to mesto seznama l vrine element x.
 Èe je k izven mej seznama, ga doda na zaèetek oz. konec.
 ----------
...
(* Funkcija "max_po_komponentah l1 l2" vrne seznam, ki ima za elemente
 veèjega od elementov na ustreznih mestih v seznamih l1 in l2.
...
(* Funkcija "drugi_najvecji l" vrne drugo najveèjo vrednost v seznamu l.
 Ponovitve elementa se štejejo kot ena vrednost.
 Predpostavimo, da ima seznam vsaj dva razlièna elementa.
 Namig: Pomagaj si s pomožno funkcijo, ki poišèe najveèjo vrednost v seznamu. 
 ----------
